      ...
      <div className='flex items-center justify-between text-sm py-4 mb-5 border-gray-400 border-b'>
         ...
         <div className='flex items-center gap-4'>
            {token ? <div className='flex items-center gap-2 cursor-pointer group relative'>
               <img className='w-8 rounded-full' src={assets.profile_pic} alt="profileimage error" />
            ...
            </div> : <button className='bg-primary text-white px-8 py-3 rounded-full hidden md:block' onClick={() => navigate('/login')}>
